              ...
              <div className="mx-auto w-full max-w-xl">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-9 w-full rounded-full border border-slate-200 bg-slate-50/80 pl-9 pr-3 text-sm text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-slate-200"
                  />
                </div>
              </div>
            </header>
