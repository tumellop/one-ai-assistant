...
export function ResultCard({
  ...
  return (
    <div className="rounded-3xl border border-white/60 bg-white/70 p-6 shadow-sm backdrop-blur-md">
      <div className="mb-4 flex items-center justify-between">
        ...
        {content && !loading && (
          <Button
            ...
            size="sm"
            onClick={onCopy}
            className="h-8 gap-1.5 rounded-full text-slate-600 hover:bg-slate-100 hover:text-slate-900"
          >
